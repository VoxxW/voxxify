...
local Library = {
	Themes = {
		Voxxify = {
			Main = Color3.fromRGB(25, 0, 51),
			Secondary = Color3.fromRGB(50, 50, 55),
			Tertiary = Color3.fromRGB(102, 0, 204),
...
function Library:create(options)
	...
	creditsTab:credit{Name = "Voxx", Description = "Developer & Maintainer of Voxxify V1", Discord = "imvoxx"}
